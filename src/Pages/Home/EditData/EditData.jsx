...
const EditData = () => {
    ...
    useEffect(() => {
        async function fetchData() {
            const response = await fetch(`https://fahim-crud-server-2rul2egi3-nurmorshed7987-gmailcom.vercel.app/addData?search=${search}&page=${currentPage}&limit=${itemPerPage}`);
